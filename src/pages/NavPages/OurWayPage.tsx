    ...
    <section className="bg-slate-800 py-16 px-4 md:px-8 rtl">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row-reverse items-start gap-8">
          ...
          <div className="md:w-4/5 md:border-l-4  md:pl-8 text-right">
            ...
            <ul className="text-white text-lg space-y-6 list-none">
              {items.map((item, index) => (
                <li key={index} className="relative pr-6 before:content-[''] before:absolute before:right-0 before:top-2 before:w-3 before:h-3  before:rounded-full">
