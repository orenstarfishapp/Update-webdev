  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white text-right">
      ...
      <div className="mt-16 text-center">
        <a href="https://socialdev.co.il" className="inline-flex items-center bg-[#F7BA00] text-white px-8 py-4 rounded-full text-xl font-semibold hover:bg-[#E5AB00] transition-colors duration-300">
          למידע נוסף
